...
<xsl:template match="gmd:identificationInfo/srv:SV_ServiceIdentification/gmd:citation/gmd:CI_Citation" priority="10">
  ...
  <xsl:template match="srv:serviceType/gco:LocalName[not(@codeSpace) or @codeSpace!='http://inspire.ec.europa.eu/metadata-codelist/SpatialDataServiceType']">
    <xsl:copy>
      <xsl:attribute name="codeSpace">http://inspire.ec.europa.eu/metadata-codelist/SpatialDataServiceType</xsl:attribute>
